...
urlpatterns = [
    ...
    path(
    "get-topics/",
    views.get_topics_by_trainer,
    name="get_topics_by_trainer"
),
    # Backward/alternate route used in some templates
    path(
    "get-topics-by-trainer/",
    views.get_topics_by_trainer,
    name="get_topics_by_trainer_alias"
),
]
